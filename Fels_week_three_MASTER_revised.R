...
# You can use plotly to make an interactive graph that shows the value of each
...
plot_ly(data = schools, x = Enrollment, y = Weapons,
        ...
        mode = "markers")
layout(hovermode = "closest") # you need to run this line to be able to "hover" on the chart

# You can also color it by categories in one column
plot_ly(data = schools, x = Enrollment, y = Weapons, color = school_type,
        text = paste("School: ", SCHOOL_NAME_1,
                     "<br>",
                     "School Level:", school_type),
        mode = "markers")
