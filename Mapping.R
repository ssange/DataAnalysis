...
# The syntax for geocoding is simply. Put the address you want in quotes,
# then say 'source = "google"' to specify that you want it go geocode 
...
# The data tells us the city andf state that the shooting occured in, but not
...
police$address <- paste(police$city, ",", police$state)
...
# To use get_map, out an address inside the quotes. It will automatically zoom
...
# The attribution isn't necessary but you should always provide it to city your 
# map tile source.
...
# fit the screen. We can affect how big they will appear by using "radius = ". I like to
...
# all of it. One hitn when setting zoom is that if you go to Google Maps and click
# on a point it will tell you the coordinates. That's an easy way to quickly find
# coordinates you want to set your view.
