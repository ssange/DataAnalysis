...
schools$predTot_susp <- predict(fit, schools)
schools$residuals <- resid(fit)
i <- order(schools$residuals)
schools <- schools[i,]
schools[c(1:3,238:240),c("Total_suspensions","predTot_susp","residuals")]
