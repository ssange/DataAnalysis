...
install.packages("effects") # display results from regression
devtools::install_github("ropensci/plotly")
install.packages("car") # useful package to run regression
install.packages("texreg") # manage regression output
...
mytable1$diff_percent <- (mytable1$diff/mytable1$MeanIncome[1])*100
mytable1
...
##################################
# present models in pretty table #
##################################
